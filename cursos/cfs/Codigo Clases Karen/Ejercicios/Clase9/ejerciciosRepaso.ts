...
// function cargarButacas(arreglo: number[], largo: number) {
//     let indice: number;
//     for (indice = 0; indice < largo; indice++) {
//         arreglo[indice] = Math.floor(Math.random() * 2); //numero booleano al azar 0 o 1
//     }
// }
// function contarButacasDesocupadas(arreglo: number[], largo: number): number {
...
// let nroButacas: number = 10;
// let butacas: number[] = new Array(nroButacas);
